...
<template>
  <div>
    ...
    <div class="relative">
      <select
        :value="modelValue"
        class="w-full appearance-none border border-neutral-200 rounded-md bg-neutral-100 px-4 py-2.5 pr-10 text-gray-900 transition-colors dark:border-gray-600 dark:bg-gray-800 dark:text-gray-100 focus:outline-none focus:border-primary"
        :disabled="disabled"
        @change="($event: Event) => {
